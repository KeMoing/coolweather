...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Build.VERSION.SDK_INT >= 21){        //Android5.0及以上的版本才会实现该功能
        ...
        carWashText = (TextView) findViewById(R.id.car_wrap_text);
    ...
    private void showWeatherInfo(Weather weather){
        ...
        for(Forecast forecast : weather.forecastList){
            ...
            if(forecast.more.nowInfo.equals(forecast.more.nextInfo)){
                infoText.setText(forecast.more.nowInfo);
            }else{
                infoText.setText(forecast.more.nowInfo + "转" + forecast.more.nextInfo);
            }
